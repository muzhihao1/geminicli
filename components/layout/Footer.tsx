...
const footerLinks = {
  'Quick Links': [
    ...
    { name: 'FAQ', href: '/qa' },
    { name: 'Installation Guide', href: '/quick-start/install' },
    { name: 'Configuration', href: '/quick-start/setup' },
  ],
  'Resources': [
    { name: 'Official Resources', href: '/resources#official' },
    { name: 'Tutorials & Guides', href: '/resources#tutorials' },
    { name: 'Tools & Extensions', href: '/resources#tools' },
    { name: 'Community Resources', href: '/resources#community' },
  ],
  'Support': [
              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-sm text-neutral-gray hover:text-google-blue transition-colors"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        <div className="mt-8 pt-8 border-t border-neutral-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-neutral-gray">
              © 2024 Gemini CLI All in One. Not officially affiliated with Google.
            </p>
            <p className="text-sm text-neutral-gray mt-2 md:mt-0">
